...
@section('container')
    <div class="card bg-base-100 shadow-xl m-4">
      <div class="card-body">
        <h2 class="card-title text-xl">Detail Data Guru</h2>
        ...
        <div class="lg:grid lg:grid-cols-4 lg:gap-4">
          <div class="row-span-4">
            @if ($guru->image)
              <img src="{{ asset('storage/'.$guru->image) }}" alt="" class="imgPreview"/>
            @else
          ...
          <div class="form-control">
            ...
            <input type="text" class="input input-bordered" value="{{ $guru->email }}" disabled/>
          </div>
          <div class="form-control">
            <label class="label">
              <span class="label-text">Password</span>
            </label>
            <input type="text" class="input input-bordered" value="{{ $guru->password }}" disabled/>
          </div>
          <div class="form-control">
            <label class="label">
              <span class="label-text">Jabatan</span>
            </label>
            <input type="text" class="input input-bordered" value="{{ ucwords($guru->jabatan) }}" disabled/>
          </div>
          <div class="form-control">
            <label class="label">
              <span class="label-text">NUPTK</span>
            </label>
            <input type="text" class="input input-bordered" value="{{ $guru->nuptk }}" disabled/>
          </div>
          <div class="form-control col-span-2">
            <label class="label">
              <span class="label-text">Nama</span>
            </label>
            <input type="text" class="input input-bordered" value="{{ ucwords($guru->nama.", ".$guru->gelar) }}" disabled/>
          </div>
          <div class="form-control">
            <label class="label">
              <span class="label-text">Tempat, tanggal lahir</span>
            </label>
            <input type="text" class="input input-bordered" value="{{ ucwords($guru->tempatlahir).", ".date('d-m-Y', strtotime($guru->tanggallahir)) }}" disabled/>
          </div>
          <div class="form-control col-span-2">
            <label class="label">
              <span class="label-text">Alamat</span>
            </label>
            <input type="text" class="input input-bordered" value="{{ ucwords($guru->alamat) }}" disabled/>
          </div>
          <div class="form-control">
            <label class="label">
              <span class="label-text">Jenis Kelamin</span>
            </label>
            <input type="text" class="input input-bordered" value="{{ $guru->jk === 'L' ? 'Laki - Laki' : 'Perempuan' }}" disabled/>
          </div>
          <div class="form-control col-span-2">
            <label class="label">
              <span class="label-text">Pendidikan</span>
            </label>
            <input type="text" class="input input-bordered" value="{{ $guru->pendidikan }}" disabled/>
          </div>
        </div>
      </div>
    </div>
