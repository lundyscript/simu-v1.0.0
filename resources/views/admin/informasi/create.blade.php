...
@section('container')
    <div class="card bg-base-100 shadow-xl m-4">
      <div class="card-body">
        <h2 class="card-title text-xl">Tambah Informasi Baru</h2>
        <form method="post" action="/admin/informasi" enctype="multipart/form-data" class="lg:grid lg:grid-cols-2 lg:gap-4">
        @csrf
          ...
          <div class="form-control">
            ...
            <input type="text" id="judul" name="judul" class="input input-bordered @error('judul') input-error @enderror" value="{{ old('judul') }}"/>
            @error('judul')
              <div class="text-error">
                {{ $message }}
              </div>
          ...
          <div class="form-control">
            ...
            <input type="text" id="slug" name="slug" class="input input-bordered @error('slug') input-error @enderror" value="{{ old('slug') }}"/>
            @error('slug')
              <div class="text-error">
                {{ $message }}
              </div>
          ...
          <div class="form-control col-span-2">
            ...
            <input id="isiartikel" name="isiartikel" type="hidden" name="content" class="@error('isiartikel') textarea-error @enderror">
